...
public class ActivityLogEntryEntity {
    ...
    // EDIT: Because a single request can affect multiple activity log types (ex. creating an account and a loyalty bank)
    // requestId will no longer be unique, meaning this id is now required.
    @Id
    private ObjectId id;

...
public class ExceptionMessages {
    ...
    public static final String ACTIVITY_LOG_WITH_ID_DOES_NOT_EXIST = String.format(ENTITY_WITH_ID_DOES_NOT_EXIST, ACTIVITY_LOG, "%s");
    public static final String TRANSACTION_NOT_FOUND = "Transaction %s not found for loyaltyBank %s";

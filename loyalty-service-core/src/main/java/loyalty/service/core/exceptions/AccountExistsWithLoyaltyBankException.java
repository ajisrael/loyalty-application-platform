...
public class AccountExistsWithLoyaltyBankException extends RuntimeException {
    public AccountExistsWithLoyaltyBankException(String accountId, String businessName) {
        super(String.format(ACCOUNT_ID_ALREADY_HAS_LOYALTY_BANK, accountId, businessName));
    }
}
